		...
		<>
			...
			<EntireRow>
				<Row $direction="column" $justify="space-evenly">
					<Text>От бутона отдолу можеш да започнеш игра с цитати и описания на герои или произведения, които трябва да познаеш. Разбери колко е най-високият резултат, който можеш да постигнеш за 5 минути.</Text>
